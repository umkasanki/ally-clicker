...
|---|---|---|
| 1 | Фундамент проекта | ⬜ не начата |
| 2 | Движок ядра | ⬜ не начата |
| 3 | Основная панель (UI) | ⬜ не начата |
| 4 | Действия кнопок | ⬜ не начата |
| 5 | Приложение настройки | ⬜ не начата |
| 6 | Интеграция и полировка | ⬜ не начата |
| 7 | Сборка и дистрибуция | ⬜ не начата |
